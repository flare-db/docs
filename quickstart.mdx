...
<Tabs>
  <Tab title="Linux and macOS">
    ```bash
    curl --proto '=https' --tlsv1.2 -LsSf https://github.com/flare-db/flare-db/releases/download/flaredb-v0.2.1/flaredb-installer.sh | sh
    ```
  </Tab>
  <Tab title="Windows">
    ```powershell
    powershell -ExecutionPolicy Bypass -c "irm https://github.com/flare-db/flare-db/releases/download/flaredb-v0.2.1/flaredb-installer.ps1 | iex"
    ```
  </Tab>
</Tabs>
